...
for tableSuffix in "${tableSuffixes[@]}"; do
    ...
    aws dynamodb update-table --endpoint ${ORIGINAL_TABLE_ENDPOINT} --table-name ${ORIGINAL_TABLE_NAME} --stream-specification "StreamEnabled=true,StreamViewType=NEW_AND_OLD_IMAGES"
