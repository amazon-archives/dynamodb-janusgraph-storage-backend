...
//https://github.com/buka/titan/blob/master/src/main/java/com/thinkaurelius/titan/diskstorage/dynamodb/DynamoDBClient.java#L26
    ...
    public static final ConfigOption<String> DYNAMODB_TABLE_PREFIX = new ConfigOption<>(DYNAMODB_CONFIGURATION_NAMESPACE, "prefix", //
        ...
        ConfigOption.Type.FIXED, "janusgraph");
...
//https://github.com/buka/titan/blob/master/src/main/java/com/thinkaurelius/titan/diskstorage/dynamodb/DynamoDBClient.java#L29
    public static final ConfigOption<Boolean> DYNAMODB_FORCE_CONSISTENT_READ = new ConfigOption<>(DYNAMODB_CONFIGURATION_NAMESPACE, "force-consistent-read", //
        "This feature sets the force consistent read property on dynamodb calls.", //
        ConfigOption.Type.MASKABLE, true);
    public static final ConfigOption<Long> STORES_CAPACITY_READ = new ConfigOption<>(Constants.DYNAMODB_STORES_NAMESPACE, "capacity-read", //
        "Define the initial read capacity for a given dynamodb table.", //
        ConfigOption.Type.GLOBAL, 4L);
    public static final ConfigOption<Long> STORES_CAPACITY_WRITE = new ConfigOption<>(Constants.DYNAMODB_STORES_NAMESPACE, "capacity-write", //
        "Define the initial write capacity for a given dynamodb table.", //
        ConfigOption.Type.GLOBAL, 4L);
    public static final ConfigOption<Double> STORES_READ_RATE_LIMIT = new ConfigOption<>(Constants.DYNAMODB_STORES_NAMESPACE, "read-rate", //
        "The max number of reads per second.", //
        ConfigOption.Type.MASKABLE, 4.0);
    public static final ConfigOption<Double> STORES_WRITE_RATE_LIMIT = new ConfigOption<>(Constants.DYNAMODB_STORES_NAMESPACE, "write-rate", //
    ...
    public static final ConfigOption<Long> DYNAMODB_CLIENT_EXECUTOR_KEEP_ALIVE = new ConfigOption<>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "keep-alive", //
...
//https://github.com/buka/titan/blob/master/src/main/java/com/thinkaurelius/titan/diskstorage/dynamodb/DynamoDBClient.java#L29
    ...
    public static final ConfigOption<Integer> DYNAMODB_CLIENT_EXECUTOR_QUEUE_MAX_LENGTH = new ConfigOption<>(DYNAMODB_CLIENT_EXECUTOR_NAMESPACE, "max-queue-length", //
